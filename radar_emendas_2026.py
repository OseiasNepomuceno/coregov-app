...
def exibir_radar():
    ...
    try:
        ...
        if tipo_visao == "Visão Geral":
            ...
            cols_fav = [col_autor, "Tipo de Emenda", col_ano_mes, "Favorecido", col_nat, "Tipo Favorecido", col_uf_fav, col_mun_fav, col_valor_rec]
    ...
    if not df_exibir.empty:
        ...
        st.warning(f"Não foram encontrados dados de 2026 para {uf_busca}.")
